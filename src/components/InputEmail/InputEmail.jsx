...
const InputEmail = () => {
   ...
   // Показываем ошибку если поле было затронуто (touched) или если есть значение
   const shouldShowError = formState.touchedFields.email || emailValue;
      ...
      <>
         ...
         <div
            className={`${styles.error} ${
               emailError && shouldShowError ? styles.errorVisible : ''
            }`}>
            {emailError}
         </div>
      </>
